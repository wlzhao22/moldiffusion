...
SUBSTITUTIONS: List[Substitution] = [
    ...
    Substitution(['N2'], '[N+]=[N-]', "[N+]=[N-]", 0),
    Substitution(['MeO2C', 'CO2Me'], 'C(=O)OC', '[C](=O)OC', 0),
    ...
    Substitution(['o'], 'O', 'O', 0.0),
    Substitution(['Cf'], 'Cl', 'Cl', 0.0),
    Substitution(['HQ'], '[OH]', '[OH]', 0.0),
    Substitution(['CH2C', 'CH2H3', 'C2CH', 'CHCH3', 'CH2C3', 'CH5', 'CH2H', 'CHH3'], '[CH2;D2][CH3]', '[CH2]C', 0.0),
